...
## 웹 성능 평가 기준
1. 로딩속도
<img width="662" alt="image" src="https://github.com/howooking/CS_Study_for_Interview/assets/87072568/3e637717-cd7b-452a-b2c8-b473433ed35a">
![image](https://github.com/howooking/CS_Study_for_Interview/assets/87072568/4175d887-7dd4-4322-871a-0f97b2a7cad1)

- FCP(First Contentful Paint): url접속 후 첫 요소가 로드 될 때까지 걸리는 시간
- FMP(First Meaningful Paint): 사용자에 의미있는 첫 요가 로드 될 때까지 걸리는 시간
- LCP(Largest Contentful Paint): 주요콘텐츠(이미지, 비디오)가  로드 될 때까지 걸리는 시간, 대부분 LCP를 기준으로 로딩속도를 측정함.
![image](https://github.com/howooking/CS_Study_for_Interview/assets/87072568/1584d5fc-dd90-4913-b5a8-4863cc9f2645)
- 
3. 렌더링
4. 메모
